...
def current_command(direction, gear, magnitude, lights):
	...
	updated_html = updated_html+wsutils.terminal_begin+"lights"+wsutils.terminal_middle+str(1 if (direction & 2) else 0)+wsutils.terminal_end
	updated_html = updated_html+wsutils.terminal_begin+"gear"+wsutils.terminal_middle+str(gear)+wsutils.terminal_end
